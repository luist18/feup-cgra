...
class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.selectedFiltering = 1;
        this.wrapS = 0;
        this.wrapT = 0;

        this.textures = [this.texture1, this.texture2, this.texture3];
        this.filtering = [this.gl.LINEAR, this.gl.NEAREST];
        ...
        this.filteringIds = { 'Linear': 0, 'Nearest': 1 };
    ...
    display() {
        ...
        if (this.displayCube) {
            this.unitCube.display(this.filtering[this.selectedFiltering]);
        }
